...
namespace Spacl.Web.Controllers
{
    public class ProductSubCategoriesController : Controller
    {
        ...
        {
            var productSubCategories = db.ProductSubCategories;
        ...
        public ActionResult Create([Bind(Include = "ProductCategoryId,Name,Remarks,IsActive")] ProductSubCategory productSubCategory)
        {
            if (ModelState.IsValid)
            {
                productSubCategory.CreatedBy = "Ash";
            ...
            ViewBag.ProductCategoryId = new SelectList(db.ProductCategories, "ProductCategoryId", "ProductType", productSubCategory.ProductCategoryId);
            return View(productSubCategory);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ProductCategoryId,Name,Remarks,IsActive")] ProductSubCategory productSubCategory)
        {
            if (ModelState.IsValid)
            {

                productSubCategory.ModifiedBy = "Ash";
