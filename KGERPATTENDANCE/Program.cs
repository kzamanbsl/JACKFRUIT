...
namespace AttendanceProcessor
{
    public class Program
    {
        ...
        static async Task Main(string[] args)
        {
            ...
            await ProcessFinalAttendance(currentDate.AddDays(-1));
            await ProcessFinalAttendance(currentDate);
        ...
        public static async Task ProcessFinalAttendance(DateTime date)
        {
            Storeproc storeproc = new Storeproc();
            SqlConnection connection = new SqlConnection(appSetting.ConnectionStrings.KGERPDB);
            SqlParameter[] parameters = new SqlParameter[1];
